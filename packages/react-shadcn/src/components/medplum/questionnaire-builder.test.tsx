...
// Modified from @medplum/react 5.1.36 packages/react/src/QuestionnaireBuilder/QuestionnaireBuilder.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { QuestionnaireBuilderProps } from '@/components/medplum/questionnaire-builder';
import { QuestionnaireBuilder } from '@/components/medplum/questionnaire-builder';
