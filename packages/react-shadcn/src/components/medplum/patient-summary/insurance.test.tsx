...
// Modified from @medplum/react 5.1.36 packages/react/src/PatientSummary/Insurance.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import { CoverageItem, Insurance } from '@/components/medplum/patient-summary/insurance';
