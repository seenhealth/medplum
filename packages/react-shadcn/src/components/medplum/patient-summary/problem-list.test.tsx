...
// Modified from @medplum/react 5.1.36 packages/react/src/PatientSummary/ProblemList.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import { ProblemList } from '@/components/medplum/patient-summary/problem-list';
import { act, fireEvent, render, screen, typeInAutocomplete } from '@/test/render';
