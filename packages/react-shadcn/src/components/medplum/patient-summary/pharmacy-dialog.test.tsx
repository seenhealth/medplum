...
// Modified from @medplum/react 5.1.36 packages/react/src/PatientSummary/PharmacyDialog.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)

import { PharmacyDialog } from '@/components/medplum/patient-summary/pharmacy-dialog';
