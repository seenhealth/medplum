...
// Modified from @medplum/react 5.1.36 packages/react/src/PatientSummary/pharmacy-utils.test.ts for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
...
import type {
  ...
  PreferredPharmacy,
} from '@/components/medplum/patient-summary/pharmacy-utils';
import {
