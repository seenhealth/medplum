...
// Modified from @medplum/react 5.1.36 packages/react/src/CcdaDisplay/CcdaDisplay.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import { Button } from '@/components/ui/button';
import { exportJsonFile, sendCommand } from '@/lib/medplum/dom';
      ...
      <div style={{ marginTop: '10px', marginBottom: '10px', display: 'flex', alignItems: 'center' }}>
        ...
        {validationResult && (
          <>
            ...
            <Button type="button" onClick={downloadResults} className="ml-auto">
