...
// Modified from @medplum/react 5.1.36 packages/react/src/ResourcePropertyInput/ResourcePropertyInput.stories.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
