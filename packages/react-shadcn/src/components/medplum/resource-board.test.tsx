...
// Modified from @medplum/react 5.1.36 packages/react/src/ResourceBoard/ResourceBoard.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { ResourceBoardProps } from '@/components/medplum/resource-board';
