...
// Modified from @medplum/react 5.1.36 packages/react/src/SearchControl/SearchUtils.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
...
import type { SearchControlField } from '@/components/medplum/search-control/search-control-field';
