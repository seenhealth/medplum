...
// Modified from @medplum/react 5.1.36 packages/react/src/SearchControl/SearchControl.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { SearchControlProps } from '@/components/medplum/search-control/search-control';
import { SearchControl } from '@/components/medplum/search-control/search-control';
