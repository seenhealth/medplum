...
// Modified from @medplum/react 5.1.36 packages/react/src/DiagnosticReportDisplay/DiagnosticReportDisplay.stories.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
...
import { LabPanelDiagnosticReport, LabPanelObservations, LabPanelSpecimen } from '@/stories/lab-panel';
