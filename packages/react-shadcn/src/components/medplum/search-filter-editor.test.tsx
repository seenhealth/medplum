...
// Modified from @medplum/react 5.1.36 packages/react/src/SearchFilterEditor/SearchFilterEditor.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import { SearchFilterEditor } from '@/components/medplum/search-filter-editor';
import { act, fireEvent, render, screen, typeInAutocomplete, waitFor } from '@/test/render';
