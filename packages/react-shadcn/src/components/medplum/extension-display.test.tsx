...
// Modified from @medplum/react 5.1.36 packages/react/src/ExtensionDisplay/ExtensionDisplay.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { ExtensionDisplayProps } from '@/components/medplum/extension-display';
