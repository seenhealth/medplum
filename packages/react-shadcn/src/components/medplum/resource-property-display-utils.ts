...
// Modified from @medplum/react 5.1.36 packages/react/src/ResourcePropertyDisplay/ResourcePropertyDisplay.utils.ts for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
