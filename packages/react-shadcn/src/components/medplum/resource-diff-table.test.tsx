...
// Modified from @medplum/react 5.1.36 packages/react/src/ResourceDiffTable/ResourceDiffTable.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { ResourceDiffTableProps } from '@/components/medplum/resource-diff-table';
