...
// Modified from @medplum/react 5.1.36 packages/react/src/ExtensionInput/ExtensionInput.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { ExtensionInputProps } from '@/components/medplum/extension-input';
