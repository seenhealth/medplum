...
// Modified from @medplum/react 5.1.36 packages/react/src/ReferenceInput/ReferenceInput.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { ReferenceInputProps } from '@/components/medplum/reference-input';
import { ReferenceInput } from '@/components/medplum/reference-input';
import { act, fireEvent, render, screen, selectAutocompleteOption, typeInAutocomplete } from '@/test/render';
