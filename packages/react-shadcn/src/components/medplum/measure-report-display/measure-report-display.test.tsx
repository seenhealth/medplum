...
// Modified from @medplum/react 5.1.36 packages/react/src/MeasureReportDisplay/MeasureReportDisplay.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { MeasureReportDisplayProps } from '@/components/medplum/measure-report-display/measure-report-display';
import { MeasureReportDisplay } from '@/components/medplum/measure-report-display/measure-report-display';
