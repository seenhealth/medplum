...
// Modified from @medplum/react 5.1.36 packages/react/src/FhirPathTable/FhirPathTable.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { FhirPathTableField, FhirPathTableProps } from '@/components/medplum/fhir-path-table';
import { FhirPathTable } from '@/components/medplum/fhir-path-table';
