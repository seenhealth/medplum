...
// Modified from @medplum/react 5.1.36 packages/react/src/EncounterTimeline/EncounterTimeline.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { EncounterTimelineProps } from '@/components/medplum/encounter-timeline';
