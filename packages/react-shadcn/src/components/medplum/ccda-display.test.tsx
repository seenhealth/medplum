...
// Modified from @medplum/react 5.1.36 packages/react/src/CcdaDisplay/CcdaDisplay.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import { CcdaDisplay } from '@/components/medplum/ccda-display';
import * as domUtils from '@/lib/medplum/dom';
