...
// Modified from @medplum/react 5.1.36 packages/react/src/ReferenceRangeEditor/ReferenceRangeEditor.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { ReferenceRangeEditorProps } from '@/components/medplum/reference-range-editor';
import { ReferenceRangeEditor } from '@/components/medplum/reference-range-editor';
import { HDLDefinition, TestosteroneDefinition } from '@/stories/reference-lab';
