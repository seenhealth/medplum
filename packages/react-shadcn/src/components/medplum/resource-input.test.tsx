...
// Modified from @medplum/react 5.1.36 packages/react/src/ResourceInput/ResourceInput.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { AsyncAutocompleteOption } from '@/components/medplum/async-autocomplete';
import type { ResourceInputProps } from '@/components/medplum/resource-input';
import { ResourceInput } from '@/components/medplum/resource-input';
import { act, clickAutocompleteOption, fireEvent, render, screen, typeInAutocomplete } from '@/test/render';
