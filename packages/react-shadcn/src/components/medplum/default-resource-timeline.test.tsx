...
// Modified from @medplum/react 5.1.36 packages/react/src/DefaultResourceTimeline/DefaultResourceTimeline.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { DefaultResourceTimelineProps } from '@/components/medplum/default-resource-timeline';
