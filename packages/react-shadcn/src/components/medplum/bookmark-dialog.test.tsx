...
// Modified from @medplum/react 5.1.36 packages/react/src/BookmarkDialog/BookmarkDialog.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import { BookmarkDialog } from '@/components/medplum/bookmark-dialog';
...
describe('BookmarkDialog', () => {
  ...
  test('Render and update error for empty id', async () => {
    ...
    expect(notify.error).toHaveBeenCalledWith('Missing id');
  });
});
