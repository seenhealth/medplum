...
// Modified from @medplum/react 5.1.36 packages/react/src/QuestionnaireResponseDisplay/QuestionnaireResponseDisplay.stories.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import { Document } from '@/components/medplum/document';
import { QuestionnaireResponseDisplay } from '@/components/medplum/questionnaire-response-display/questionnaire-response-display';
