...
// Modified from @medplum/react 5.1.36 packages/react/src/ResourceBlame/ResourceBlame.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { ResourceBlameProps } from '@/components/medplum/resource-blame/resource-blame';
import { ResourceBlame } from '@/components/medplum/resource-blame/resource-blame';
import { getTimeString } from '@/components/medplum/resource-blame/resource-blame-utils';
