...
// Modified from @medplum/react 5.1.36 packages/react/src/LinkTabs/LinkTabs.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)

import { LinkTabs } from '@/components/medplum/link-tabs';
