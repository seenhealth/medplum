...
// Modified from @medplum/react 5.1.36 packages/react/src/ResourceBoard/ResourceBoard.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type {
  ListWithDetailPaneDetailContext,
  ListWithDetailPaneHeaderProps,
  ListWithDetailPaneItemContext,
  ListWithDetailPaneTab,
} from '@/components/medplum/list-with-detail-pane/list-with-detail-pane';
