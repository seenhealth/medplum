...
// Modified from @medplum/react 5.1.36 packages/react/src/CalendarDateInput/useDayRangeDrag.ts for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import { isSameDay, sortEnds } from '@/components/medplum/calendar-date-input/calendar-date-input-utils';
