...
// Modified from @medplum/react 5.1.36 packages/react/src/AttachmentDisplay/AttachmentDisplay.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { AttachmentDisplayProps } from '@/components/medplum/attachment-display/attachment-display';
