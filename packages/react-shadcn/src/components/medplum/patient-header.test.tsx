...
// Modified from @medplum/react 5.1.36 packages/react/src/PatientHeader/PatientHeader.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import { PatientHeader } from '@/components/medplum/patient-header';
