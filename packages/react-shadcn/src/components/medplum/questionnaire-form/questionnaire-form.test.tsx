...
// Modified from @medplum/react 5.1.36 packages/react/src/QuestionnaireForm/QuestionnaireForm.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
...
describe('QuestionnaireForm', () => {
  ...
  test('Handles submit', async () => {
    ...
    expect(screen.queryByLabelText('q7')).not.toBeChecked();
    expect(screen.queryByLabelText('q8')).toBeChecked();
  ...
  test('Checkbox optionExclusive', async () => {
    ...
    expect(peanuts).toBeChecked();
    expect(shellfish).toBeChecked();
    ...
    expect(peanuts).not.toBeChecked();
    expect(shellfish).not.toBeChecked();
    ...
    expect(peanuts).toBeChecked();
    expect(noAllergies).not.toBeChecked();
  ...
  test('Multi-Select Dropdown optionExclusive', async () => {
    ...
    const selectOption = async (label: string): Promise<void> => {
      ...
      await typeInAutocomplete(input, label);
