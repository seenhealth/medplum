...
// Modified from @medplum/react 5.1.36 packages/react/src/QuestionnaireForm/AIRealTimeQuestionnaireForm.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { AIRealTimeQuestionnaireFormProps } from '@/components/medplum/questionnaire-form/ai-real-time-questionnaire-form';
import { AIRealTimeQuestionnaireForm } from '@/components/medplum/questionnaire-form/ai-real-time-questionnaire-form';
