...
// Modified from @medplum/react 5.1.36 packages/react/src/BackboneElementInput/BackboneElementInput.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { BackboneElementInputProps } from '@/components/medplum/backbone-element-input';
...
import type { InternalSchemaElement, TypeInfo } from '@medplum/core';
