...
// Modified from @medplum/react 5.1.36 packages/react/src/SearchPopupMenu/SearchPopupMenu.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import { getFieldDefinitions } from '@/components/medplum/search-control/search-control-field';
import type { SearchPopupMenuProps } from '@/components/medplum/search-popup-menu';
import { SearchPopupMenu } from '@/components/medplum/search-popup-menu';
import { Button } from '@/components/ui/button';
import { DropdownMenu, DropdownMenuTrigger } from '@/components/ui/dropdown-menu';
import { act, fireEvent, render, screen, userEvent } from '@/test/render';
