...
// Modified from @medplum/react 5.1.36 packages/react/src/ResourceForm/ResourceForm.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import { convertIsoToLocal, convertLocalToIso } from '@/components/medplum/date-time-input-utils';
import type { ResourceFormProps } from '@/components/medplum/resource-form';
import { ResourceForm } from '@/components/medplum/resource-form';
...
describe('ResourceForm', () => {
  ...
  test('Remove CodeableConcept', async () => {
    ...
    const fooClearButton = screen.getByRole('button', { name: 'Remove foo' });
