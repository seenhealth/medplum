...
// Modified from @medplum/react 5.1.36 packages/react/src/AsyncAutocomplete/AsyncAutocomplete.stories.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
...
export function SlowAsyncAutocomplete(): JSX.Element {
  ...
  return (
    <>
      ...
      <h6 className="mt-4 font-semibold">Values</h6>
