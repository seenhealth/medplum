...
// Modified from @medplum/react 5.1.36 packages/react/src/ResourceArrayInput/ResourceArrayInput.test.tsx for @medplum/react-shadcn (Apache-2.0 §4(b) notice)
import type { ResourceArrayInputProps } from '@/components/medplum/resource-array-input';
